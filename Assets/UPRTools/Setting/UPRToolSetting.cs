...
namespace  UPRProfiler
{
    ...
    public class UPRToolSetting
    {
        ...
        private bool m_enableURPOverdraw = false;
        ...
        public bool enableURPOverdraw
        {
            get
            {
                return m_enableURPOverdraw;
            }
            set
            {
                if (this.m_enableURPOverdraw != value)
                {
                    m_enableURPOverdraw = value;
                    this.Save();
                }
            }
        }
        public static UPRToolSetting Load()
        {
            ...
            if (datas != null)
            {
                ...
                try
                {
                    ...
                    uprToolSetting.m_enableURPOverdraw = binaryReader.ReadBoolean();
                    binaryReader.Close();
                }
                catch
                {
        ...
        public void Save()
        {
            ...
            binaryWriter.Write(this.m_enableURPOverdraw);
            output.Flush();
            binaryWriter.Close();
    #endif
        }

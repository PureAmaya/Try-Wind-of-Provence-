...
namespace UPRLuaProfiler
{
    public static class Parse
    {
        public static readonly string LOCAL_PROFILER =
            "local BeginMikuSample = rawget(_G, 'UPRLuaProfiler').LuaProfiler.BeginSample "
            + "local EndMikuSample = rawget(_G, 'UPRLuaProfiler').LuaProfiler.EndSample " + "local miku_unpack_return_value = rawget(_G, 'miku_unpack_return_value') local MikuMainChunkFun = function(...) ";
        #region parse

...
namespace UPRLuaProfiler
{
    ...
    public class StringLoadInfo
    {
        ...
        private static StringBuilder operateCache = new StringBuilder(1024);
        public StringLoadInfo(string s)
        {
            operateDict.Clear();
            operateCache.Remove(0, operateCache.Length);
        ...
        public void _Handle(int start, string value, int len = 0)
        {
        ...
        public string code
        {
            get
            {
                ...
                string result = operateCache.ToString();
                return result;
            }
        }
    ...
    public class LLex
    {
        ...
        {
            LoadInfo._Handle(startPos, value);
        }
        ...
        {
            LoadInfo._Handle(start, value, end + 1 - start);
        }
